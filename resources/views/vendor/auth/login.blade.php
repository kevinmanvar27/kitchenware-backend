...
<head>
    ...
    <title>Vendor Login - {{ config('app.name', 'Laravel') }}</title>
                ...
                <div class="card login-card shadow-sm border-0">
                    <div class="card-body p-5">
                        <div class="text-center mb-5">
                            ...
                            @endif
                            <h1 class="h2 fw-bold">Vendor Login</h1>
                            <p class="text-secondary">Sign in to manage your store</p>
                        </div>
                        ...
                        <div class="text-center mt-4">
                            <p class="text-secondary mb-0">
                                ...
                                <a href="{{ route('vendor.register') }}" class="text-primary text-decoration-none fw-medium">Register here</a>
                            </p>
                            <p class="text-secondary mb-0 mt-2">
                                Are you a staff member? 
                                <a href="{{ route('vendor.staff.login') }}" class="text-primary text-decoration-none fw-medium">Staff Login</a>
                            </p>
                            <p class="text-secondary mb-0 mt-2">
