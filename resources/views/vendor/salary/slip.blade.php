...
<div class="container-fluid h-100">
    <div class="row h-100">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
            @include('vendor.layouts.header', ['pageTitle' => 'Salary Slip'])
                    ...
                    <div class="col-lg-8">
                        <div class="card border-0 shadow-sm">
                            <div class="card-header bg-white border-0 py-3 d-flex justify-content-between align-items-center">
                                ...
                                <div>
                                    <a href="{{ route('vendor.salary.payments', ['month' => $payment->month, 'year' => $payment->year]) }}" 
                            ...
                            <div class="card-body" id="salarySlip">
                                ...
                                <div class="text-center border-bottom pb-3 mb-4">
                                    ...
                                    @if($vendor && $vendor->logo)
                                        <img src="{{ asset('storage/' . $vendor->logo) }}" alt="{{ $vendor->business_name }}" height="60" class="mb-2">
                                    @endif
                                    <h4 class="mb-1">{{ $vendor->business_name ?? 'Company Name' }}</h4>
                                    <p class="text-muted mb-0">{{ $vendor->address ?? '' }}</p>
                                </div>
                                
                                <h5 class="text-center mb-4">SALARY SLIP FOR {{ strtoupper($payment->period ?? date('F Y', mktime(0, 0, 0, $payment->month, 1, $payment->year))) }}</h5>
                                    ...
                                    <div class="col-md-6">
                                        <table class="table table-borderless table-sm">
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ ucfirst(str_replace('_', ' ', $payment->user->user_role ?? 'Staff')) }}</td>
                                            </tr>
                                        </table>
                                    </div>
                                    <div class="col-md-6">
                                        <table class="table table-borderless table-sm">
                                            <tr>
                                                ...
                                                <td class="fw-medium">{{ $payment->period ?? date('F Y', mktime(0, 0, 0, $payment->month, 1, $payment->year)) }}</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <span class="badge {{ $payment->status_badge_class ?? 'bg-secondary' }} rounded-pill">
                                ...
                                <div class="card bg-light border-0 mb-4">
                                    <div class="card-body">
                                        ...
                                        <div class="row text-center">
                                            ...
                                            <div class="col">
                                                <div class="h4 mb-0 text-secondary">{{ $payment->holiday_days ?? 0 }}</div>
                                            ...
                                            <div class="card-body">
                                                <table class="table table-borderless table-sm mb-0">
                                                    <tr>
                                                        ...
                                                        <td class="text-end">₹{{ number_format($payment->base_salary ?? 0, 2) }}</td>
                                                    </tr>
                                                    <tr>
                                                        <td>Current Daily Rate</td>
                                                        <td class="text-end">₹{{ number_format($payment->daily_rate ?? 0, 2) }}</td>
                                                    </tr>
                                                    <tr class="border-top">
                                                        <td>Earned Salary</td>
                                    ...
                                    <div class="col-md-6">
                                        <table class="table table-borderless table-sm">
                                            ...
                                            <tr>
                                                ...
                                                <td class="fw-medium text-danger">₹{{ number_format($payment->pending_amount ?? ($payment->net_salary - $payment->paid_amount), 2) }}</td>
                                            </tr>
                                        </table>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <table class="table table-sm table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="badge {{ $attendance->status_badge_class ?? 'bg-secondary' }} rounded-pill">
                                                            {{ $attendance->status_label ?? ucfirst($attendance->status) }}
                                                        </span>
                                                    </td>
