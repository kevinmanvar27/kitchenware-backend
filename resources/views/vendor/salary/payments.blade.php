...
<div class="container-fluid h-100">
    <div class="row h-100">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
            @include('vendor.layouts.header', ['pageTitle' => 'Payroll Management'])
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-8">
                                        <div class="d-flex justify-content-end gap-2 flex-wrap align-items-center">
                                            ...
                                            <a href="{{ route('vendor.salary.payments', ['month' => $month, 'year' => $year, 'refresh' => 1]) }}" 
                                               class="btn btn-outline-secondary rounded-pill">
                                                <i class="fas fa-sync-alt me-1"></i> Recalculate All
                                            </a>
                                            <a href="{{ route('vendor.salary.index') }}" class="btn btn-outline-primary rounded-pill">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ $payment->user->avatar_url ?? asset('images/default-avatar.png') }}" class="rounded-circle me-2" width="36" height="36" alt="{{ $payment->user->name }}">
                                                        <div>
                                                ...
                                                <td>
                                                    <div class="btn-group btn-group-sm" role="group">
                                                        ...
                                                        <a href="{{ route('vendor.salary.payments.slip', $payment->id) }}" class="btn btn-outline-info rounded-end-pill">
...
<script>
    ...
    function updatePayroll() {
        ...
        window.location.href = `{{ route('vendor.salary.payments') }}?month=${month}&year=${year}`;
    }
    
    function openPaymentModal(payment) {
        currentPayment = payment;
        document.getElementById('paymentForm').action = `/vendor/salary/payments/${payment.id}/process`;
    ...
    function openAdjustmentModal(payment) {
        currentPayment = payment;
        document.getElementById('adjustmentForm').action = `/vendor/salary/payments/${payment.id}/adjustments`;
