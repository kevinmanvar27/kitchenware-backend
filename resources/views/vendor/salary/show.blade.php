...
<div class="container-fluid h-100">
    <div class="row h-100">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
            @include('vendor.layouts.header', ['pageTitle' => 'Salary Details'])
                        ...
                        <div class="row align-items-center">
                            <div class="col-auto">
                                <div class="position-relative">
                                    <img src="{{ $user->avatar_url ?? asset('images/default-avatar.png') }}" class="rounded-circle border border-3 border-white shadow" width="90" height="90" alt="{{ $user->name }}" style="object-fit: cover;">
                            ...
                            <div class="col">
                                ...
                                <span class="badge bg-white text-dark rounded-pill px-3 py-2">
                                    <i class="fas fa-user-tag me-1"></i>{{ ucfirst(str_replace('_', ' ', $user->user_role ?? 'Staff')) }}
                                </span>
                            </div>
                            <div class="col-auto">
                                <a href="{{ route('vendor.salary.create', ['user_id' => $user->id]) }}" class="btn btn-light rounded-pill px-4 py-2 shadow-sm">
                                    <i class="fas fa-edit me-2"></i> Update Salary
                                </a>
                                <a href="{{ route('vendor.salary.index') }}" class="btn btn-outline-light rounded-pill px-4 py-2 ms-2">
                            ...
                            <div class="card-body">
                                ...
                                @else
                                    <div class="text-center py-5">
                                        ...
                                        <a href="{{ route('vendor.salary.create', ['user_id' => $user->id]) }}" class="btn btn-theme rounded-pill px-4">
