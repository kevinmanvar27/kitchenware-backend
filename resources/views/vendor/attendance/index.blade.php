...
<div class="container-fluid h-100">
    <div class="row h-100">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
            @include('vendor.layouts.header', ['pageTitle' => 'Attendance Management'])
                            ...
                            <div class="card-header bg-white border-0 py-3">
                                <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-2 gap-md-0">
                                    ...
                                    <div class="d-flex flex-wrap gap-2">
                                        <a href="{{ route('vendor.attendance.bulk', ['date' => \Carbon\Carbon::today()->format('Y-m-d')]) }}" class="btn btn-sm btn-md-normal btn-theme rounded-pill px-3 px-md-4">
                                        ...
                                        <a href="{{ route('vendor.attendance.report', ['month' => $month, 'year' => $year]) }}" class="btn btn-sm btn-md-normal btn-outline-primary rounded-pill px-3 px-md-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mb-4">
                                    <div class="col-md-4">
                                        ...
                                        <select class="form-select rounded-pill" id="userSelect" onchange="updateCalendar()">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select class="form-select rounded-pill" id="monthSelect" onchange="updateCalendar()">
                                            @for($m = 1; $m <= 12; $m++)
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select class="form-select rounded-pill" id="yearSelect" onchange="updateCalendar()">
                                ...
                                <div class="attendance-calendar">
                                    ...
                                    <div class="row text-center">
                                        ...
                                        <div class="col border p-2 calendar-day {{ !$day['isCurrentMonth'] ? 'bg-light text-muted' : '' }} {{ $day['isToday'] ? 'border-primary border-2' : '' }}"
                                             style="min-height: 80px; cursor: {{ $day['isCurrentMonth'] && !$day['isFuture'] && $selectedUser ? 'pointer' : 'default' }};"
                                             @if($day['isCurrentMonth'] && !$day['isFuture'] && $selectedUser)
...
<div class="modal fade" id="attendanceModal" tabindex="-1" aria-labelledby="attendanceModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow">
            ...
            <form id="attendanceForm" method="POST" action="{{ route('vendor.attendance.store') }}">
                @csrf
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control rounded-pill" id="modalDateDisplay" readonly>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="time" class="form-control rounded-pill" name="check_in" id="modalCheckIn">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label fw-medium">Check Out</label>
                            <input type="time" class="form-control rounded-pill" name="check_out" id="modalCheckOut">
                        </div>
                    </div>
...
<script>
    function updateCalendar() {
        ...
        window.location.href = `{{ route('vendor.attendance.index') }}?user_id=${userId}&month=${month}&year=${year}`;
    }
    ...
    function openAttendanceModal(date, currentStatus) {
        ...
        if (currentStatus) {
            ...
            const elementId = statusMap[currentStatus];
            if (elementId) {
