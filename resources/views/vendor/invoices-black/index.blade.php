...
@section('title', 'Without GST Invoices')
...
<div class="container-fluid h-100">
    <div class="row h-100">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
            @include('vendor.layouts.header', ['pageTitle' => 'Without GST Invoices'])
                        ...
                        <div class="card border-0 shadow-sm">
                            <div class="card-header bg-white border-0 py-3">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <a href="{{ route('vendor.invoices.index') }}" class="btn btn-outline-primary rounded-pill px-3">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if($invoice->user)
                                                            {{ $invoice->user->name }}
                                                        @else
                                                            Guest ({{ substr($invoice->session_id ?? 'N/A', 0, 8) }}...)
                                                        @endif
                                                    </td>
                                                    ...
                                                    <td>
                                                        <div class="btn-group btn-group-sm" role="group">
                                                            <a href="{{ route('vendor.invoices-black.show', $invoice->id) }}" class="btn btn-outline-secondary rounded-start-pill px-3">
                                                                <i class="fas fa-edit"></i>
                                                            </a>
                                                            <form action="{{ route('vendor.invoices-black.destroy', $invoice->id) }}" method="POST" class="d-inline">
                                                                @csrf
                                                                @method('DELETE')
