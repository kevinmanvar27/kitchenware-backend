...
<div class="container-fluid h-100">
    <div class="row h-100">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
            @include('vendor.layouts.header', ['pageTitle' => 'Edit Lead'])
                        ...
                        <div class="card border-0 shadow-sm">
                            <div class="card-header bg-white border-0 py-3">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        <h4 class="card-title mb-0 fw-bold">Edit Lead</h4>
                                        <p class="mb-0 text-muted small">Update lead information</p>
                                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ route('vendor.leads.update', $lead) }}" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control rounded-pill @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name', $lead->name) }}" required>
                                        @error('name')
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control rounded-pill @error('contact_number') is-invalid @enderror" id="contact_number" name="contact_number" value="{{ old('contact_number', $lead->contact_number) }}" required>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select rounded-pill @error('status') is-invalid @enderror" id="status" name="status" required>
                                            ...
                                            <option value="followup" {{ old('status', $lead->status) == 'followup' ? 'selected' : '' }}>Follow Up</option>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <textarea class="form-control @error('note') is-invalid @enderror" id="note" name="note" rows="4">{{ old('note', $lead->note) }}</textarea>
                                        @error('note')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
