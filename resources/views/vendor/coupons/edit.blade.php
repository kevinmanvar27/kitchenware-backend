...
<div class="container-fluid h-100">
    <div class="row h-100">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
            @include('vendor.layouts.header', ['pageTitle' => 'Edit Coupon'])
                                ...
                                <form action="{{ route('vendor.coupons.update', $coupon) }}" method="POST">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <small class="text-muted">Leave empty for unlimited uses (Used: {{ $coupon->usage_count ?? 0 }})</small>
                                        </div>
                                    ...
                                    <div class="d-flex justify-content-end gap-2">
                                        <a href="{{ route('vendor.coupons.index') }}" class="btn btn-outline-secondary rounded-pill px-4">
                        ...
                        <div class="card border-0 shadow-sm mb-4">
                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    ...
                                    <span class="fw-bold fs-5">{{ $coupon->usage_count ?? 0 }}</span>
                                </div>
                                @if($coupon->usage_limit)
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    <span class="text-muted">Remaining:</span>
                                    <span class="fw-bold fs-5">{{ max(0, $coupon->usage_limit - ($coupon->usage_count ?? 0)) }}</span>
                                </div>
                                <div class="progress" style="height: 10px;">
                                    @php $usagePercent = min(100, (($coupon->usage_count ?? 0) / $coupon->usage_limit) * 100); @endphp
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    @php $status = $coupon->status ?? 'active'; @endphp
                                    @switch($status)
                                        @case('active')
