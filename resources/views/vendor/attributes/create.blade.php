...
<div class="container-fluid h-100">
    <div class="row h-100">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
            @include('vendor.layouts.header', ['pageTitle' => 'Create Attribute'])
                        ...
                        <div class="card border-0 shadow-sm">
                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ route('vendor.attributes.store') }}" method="POST">
                                    ...
                                    <div class="mb-4">
                                        <label for="type" class="form-label fw-bold">Attribute Type</label>
                                        <select class="form-select rounded-pill" id="type" name="type">
                                            ...
                                            <option value="color" {{ old('type') == 'color' ? 'selected' : '' }}>Color (Color Picker)</option>
                                            <option value="button" {{ old('type') == 'button' ? 'selected' : '' }}>Button (Text Buttons)</option>
                                        </select>
                                        <div class="form-text">Choose how this attribute will be displayed to customers</div>
                                    </div>
                                    ...
                                    <div id="values-container">
                                        <div class="value-row mb-3">
                                            <div class="row g-2">
                                                ...
                                                <div class="col-md-3">
                                                    <input type="text" class="form-control rounded-pill px-4" name="values[0][slug]" placeholder="Slug (auto-generated)">
                                                </div>
                                                <div class="col-md-3">
                                                    <input type="color" class="form-control form-control-color" name="values[0][color_code]" value="#000000" title="Choose color">
                                                </div>
                                                <div class="col-md-2">
                                    ...
                                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                        <a href="{{ route('vendor.attributes.index') }}" class="btn btn-outline-secondary rounded-pill px-4">Cancel</a>
        ...
        addValueBtn.addEventListener('click', function() {
            ...
            newRow.innerHTML = `
                <div class="row g-2">
                    ...
                    <div class="col-md-3">
                        <input type="text" class="form-control rounded-pill px-4" name="values[${valueIndex}][slug]" placeholder="Slug (auto-generated)">
                    </div>
                    <div class="col-md-3">
                        <input type="color" class="form-control form-control-color" name="values[${valueIndex}][color_code]" value="#000000" title="Choose color">
                    </div>
                    <div class="col-md-2">
