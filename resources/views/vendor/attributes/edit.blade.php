...
<div class="container-fluid h-100">
    <div class="row h-100">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
            @include('vendor.layouts.header', ['pageTitle' => 'Edit Attribute'])
                    ...
                    <div class="col-lg-8">
                        <div class="card border-0 shadow-sm">
                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ route('vendor.attributes.update', $attribute) }}" method="POST">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <select class="form-select rounded-pill" id="type" name="type">
                                            ...
                                            <option value="color" {{ old('type', $attribute->type) == 'color' ? 'selected' : '' }}>Color (Color Picker)</option>
                                            <option value="button" {{ old('type', $attribute->type) == 'button' ? 'selected' : '' }}>Button (Text Buttons)</option>
                                        </select>
                                    </div>
                                            ...
                                            @forelse($attribute->values as $value)
                                                <tr>
                                                    ...
                                                    <td class="text-end">
                                                        ...
                                                        <form action="{{ route('vendor.attributes.values.destroy', [$attribute, $value]) }}" method="POST" class="d-inline" onsubmit="return confirm('Are you sure you want to delete this value?');">
                                                            @csrf
                                                            @method('DELETE')
...
<div class="modal fade" id="addValueModal" tabindex="-1" aria-labelledby="addValueModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ route('vendor.attributes.values.store', $attribute) }}" method="POST">
                @csrf
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label for="add_color_code" class="form-label fw-bold">Color Code</label>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        editValueBtns.forEach(btn => {
            btn.addEventListener('click', function() {
                ...
                // Set form action - build URL manually to avoid route parameter issues
                editValueForm.action = '{{ url("vendor/attributes/" . $attribute->id . "/values") }}/' + valueId;
