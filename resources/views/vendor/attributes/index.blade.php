...
<div class="container-fluid h-100">
    <div class="row h-100">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
            @include('vendor.layouts.header', ['pageTitle' => 'Product Attributes'])
                        ...
                        <div class="card border-0 shadow-sm">
                            <div class="card-header bg-white border-0 py-3">
                                <div class="d-flex justify-content-between align-items-start align-items-md-center gap-2 gap-md-0">
                                    ...
                                    <a href="{{ route('vendor.attributes.create') }}" class="btn btn-theme rounded-pill px-4">
                                            ...
                                            <div class="card h-100 border">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="d-flex flex-wrap gap-1 mb-3">
                                                        @forelse($attribute->values as $value)
                                                            @if($value->color_code)
                                                                <span class="badge border" style="background-color: {{ $value->color_code }};">
                                                                    {{ $value->value }}
                                                                </span>
                                                            @else
                                                ...
                                                <div class="card-footer bg-white border-top">
                                                    <div class="d-flex justify-content-end gap-2">
                                                        <a href="{{ route('vendor.attributes.show', $attribute) }}" class="btn btn-sm btn-outline-info rounded-pill px-3" title="View">
                                                            <i class="fas fa-eye"></i>
                                                        </a>
                                                        <a href="{{ route('vendor.attributes.edit', $attribute) }}" class="btn btn-sm btn-outline-primary rounded-pill px-3" title="Edit">
                                                            <i class="fas fa-edit"></i>
                                                        </a>
                                                        <form action="{{ route('vendor.attributes.destroy', $attribute) }}" method="POST" class="d-inline" onsubmit="return confirm('Are you sure you want to delete this attribute? This will also delete all its values.');">
                                                            @csrf
                                                            @method('DELETE')
