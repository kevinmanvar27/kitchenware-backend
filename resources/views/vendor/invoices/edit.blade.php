...
<div class="container-fluid h-100">
    <div class="row h-100">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
            @include('vendor.layouts.header', ['pageTitle' => 'Edit Invoice'])
            ...
            <div class="pt-4 pb-2 mb-3">
                ...
                <form action="{{ route('vendor.invoices.update', $invoice) }}" method="POST" id="invoiceForm">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="card border-0 shadow-sm mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div id="noProducts" class="text-center py-4 text-muted" style="display: none;">
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="card border-0 shadow-sm mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between mb-2">
                                        <span>Items:</span>
                                        <span id="itemCount">{{ count($cartItems) }}</span>
                                    </div>
                                    <hr>
                                    <div class="d-flex justify-content-between">
                                        <span class="fw-bold">Total:</span>
                                        <span class="fw-bold fs-5" id="totalAmount">₹{{ number_format($invoice->total_amount, 2) }}</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card border-0 shadow-sm">
                                <div class="card-body">
                                    <div class="d-grid gap-2">
                                        <button type="submit" class="btn btn-theme rounded-pill" id="submitBtn">
                                            <i class="fas fa-save me-1"></i> Update Invoice
                                        </button>
                                        <a href="{{ route('vendor.invoices.show', $invoice) }}" class="btn btn-outline-secondary rounded-pill">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    let products = @json($cartItems).map((item, index) => ({
        id: item.product_id,
