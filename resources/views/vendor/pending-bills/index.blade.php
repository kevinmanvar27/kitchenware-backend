...
<div class="container-fluid h-100">
    <div class="row h-100">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
            @include('vendor.layouts.header', ['pageTitle' => 'Pending Bills'])
            ...
            <div class="pt-4 pb-2 mb-3">
                    ...
                    <div class="col-6 col-md-6 mb-3">
                        <div class="card border-0 shadow-sm">
                            <div class="card-body text-center py-2 py-md-3">
                                ...
                                <p class="mb-0 mt-2 text-muted small">Partially Paid Bills</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-body">
                        <form action="{{ route('vendor.pending-bills.index') }}" method="GET" class="row g-3">
                                ...
                                <select name="user_id" class="form-select rounded-pill">
                                    ...
                                    @foreach($users as $user)
                                        @php
                                            ...
                                            // If user is deleted, try to get original name from their invoices
                                            if ($displayName === 'Deleted User') {
                                                $userInvoice = \App\Models\ProformaInvoice::where('user_id', $user->id)->first();
                                                if ($userInvoice) {
                                                    ...
                                                    if (isset($invoiceData['customer']['name'])) {
                                                        $displayName = $invoiceData['customer']['name'] . ' (Deleted)';
                                                    }
                                                }
                                            }
                                        @endphp
                            ...
                            <div class="col-6 col-sm-6 col-md-2">
                                ...
                                <select name="payment_status" class="form-select rounded-pill">
                                    ...
                                    <option value="partial" {{ $paymentStatus == 'partial' ? 'selected' : '' }}>Partial Only</option>
                                </select>
                            </div>
                            <div class="col-6 col-sm-6 col-md-2">
                            ...
                            <div class="col-12 col-sm-12 col-md-3 d-flex align-items-end gap-2 flex-wrap">
                                ...
                                <a href="{{ route('vendor.pending-bills.index') }}" class="btn btn-outline-secondary rounded-pill px-4 flex-grow-1 flex-md-grow-0">
                ...
                <div class="card border-0 shadow-sm">
                    <div class="card-header bg-white border-0 py-3">
                        <div>
                            ...
                            <p class="mb-0 text-muted small">Showing bills with pending payments only</p>
                        </div>
                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="d-none d-md-table-cell">
                                                @if($invoice->user)
                                                    ...
                                                    @endphp
                                                    <a href="{{ route('vendor.pending-bills.user', $invoice->user_id) }}" class="text-decoration-none">
                                                        {{ $displayName }}
                                        ...
                                        <div class="modal fade" id="paymentModal{{ $invoice->id }}" tabindex="-1">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="{{ route('vendor.pending-bills.record-payment', $invoice->id) }}" method="POST">
                                                        @csrf
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="number" name="amount" id="vendorAmount{{ $invoice->id }}" class="form-control" 
                                                            ...
                                                            <div class="d-grid gap-2 mb-3">
                                                                <button type="button" class="btn btn-outline-primary btn-sm"
                                                                        onclick="document.getElementById('vendorAmount{{ $invoice->id }}').value = '{{ number_format($pendingAmount, 2, '.', '') }}'">
