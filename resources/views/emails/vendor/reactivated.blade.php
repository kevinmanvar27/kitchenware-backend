...
<head>
    ...
    <title>Vendor Account Reactivated - {{ config('app.name') }}</title>
    <style>
        /* Reset */
    ...
    <div class="email-wrapper">
        <div class="email-container">
            <div class="email-header">
                ...
                <span class="status-badge">✓ Reactivated</span>
            </div>
            
            <div class="email-content">
                <h2 class="greeting">Great news, {{ $user->name }}!</h2>
                
                <p>We're pleased to inform you that your vendor account for "<strong>{{ $vendor->store_name }}</strong>" has been reactivated!</p>
                
                <div class="alert-box success">
                    <span class="alert-icon">🚀</span>
                    <div class="alert-content">
                        <p class="alert-title">Your store is back online!</p>
                        <p class="alert-text">You can now continue managing your products and processing orders.</p>
                    </div>
                </div>
                ...
                <div class="info-card">
                    ...
                    <div class="info-row">
                        <span class="info-label">Vendor Panel</span>
                        <span class="info-value">{{ url('/vendor/login') }}</span>
                    </div>
                    <div class="info-row">
                        <span class="info-label">Reactivated On</span>
                        <span class="info-value">{{ now()->format('d M Y, h:i A') }}</span>
                    </div>
                </div>
                
                <h3 class="section-title">Resume your business</h3>
                
                <div class="features-grid">
                    <div class="feature-item">
                        <div class="feature-icon">📦</div>
                        <p class="feature-title">Manage Products</p>
                    </div>
                    <div class="feature-item">
                        <div class="feature-icon">🛒</div>
                        <p class="feature-title">Process Orders</p>
                    </div>
                    <div class="feature-item">
                        <div class="feature-icon">📊</div>
                ...
                <p>Thank you for your patience and cooperation. We're glad to have you back! Happy selling!</p>
