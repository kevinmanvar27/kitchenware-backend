            ...
            <div class="pt-4 pb-2 mb-3">
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <div class="card border-0 shadow-sm mb-4">
                            <div class="card-header bg-white border-0 py-3 d-flex justify-content-between align-items-center">
                                ...
                                <div>
                                    <a href="{{ route('admin.coupons.edit', $coupon) }}" class="btn btn-outline-primary rounded-pill px-3">
                            ...
                            <div class="card-body">
                                @if($coupon->usages->count() > 0)
                                    <div class="table-responsive">
                                        <table class="table table-hover align-middle" id="usageHistoryTable">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if($usage->proformaInvoice)
                                                            <a href="{{ route('admin.proforma-invoice.show', $usage->proforma_invoice_id) }}">
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="card border-0 shadow-sm">
                            <div class="card-body">
                                <a href="{{ route('admin.coupons.edit', $coupon) }}" class="btn btn-theme w-100 rounded-pill mb-2">
                                    <i class="fas fa-edit me-2"></i>Edit Coupon
                                </a>
                                <a href="{{ route('admin.coupons.index') }}" class="btn btn-outline-secondary w-100 rounded-pill">
...
<script>
    $(document).ready(function() {
        // Initialize DataTable for usage history if table exists
        if ($('#usageHistoryTable').length) {
            $('#usageHistoryTable').DataTable({
                "order": [[3, "desc"]], // Sort by Date (descending)
                "pageLength": 25,
                "lengthMenu": [[10, 25, 50, 100, -1], [10, 25, 50, 100, "All"]],
                "language": {
                    "search": "Search usage history:",
                    "lengthMenu": "Show _MENU_ entries per page",
                    "info": "Showing _START_ to _END_ of _TOTAL_ entries",
                    "infoEmpty": "No usage history available",
                    "infoFiltered": "(filtered from _MAX_ total entries)",
                    "zeroRecords": "No matching records found",
                    "emptyTable": "No usage history available"
                },
                "responsive": true,
