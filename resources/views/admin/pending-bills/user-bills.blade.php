...
@section('title', ($customerData['name'] ?? $user->name) . ' - Pending Bills - ' . setting('site_title', 'Admin Panel'))
...
<div class="container-fluid h-100">
    <div class="row h-100">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
            @include('admin.layouts.header', ['pageTitle' => ($customerData['name'] ?? $user->name) . ' - Bills'])
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="number" name="amount" id="userAmount{{ $invoice->id }}" class="form-control" 
                                                            ...
                                                            <div class="d-grid gap-2 mb-3">
                                                                <button type="button" class="btn btn-outline-primary btn-sm"
                                                                        onclick="document.getElementById('userAmount{{ $invoice->id }}').value = '{{ number_format($pendingAmount, 2, '.', '') }}'">
