                            ...
                            <div class="card-body">
                                ...
                                @else
                                    <div class="alert alert-warning rounded-3 mb-4">
                                        ...
                                        <strong>{{ $paginatedProducts->count() }} product(s)</strong> have stock levels below their threshold. Consider restocking soon!
                                    </div>
...
$(document).ready(function() {
    if ($('#lowStockTable').length && $('#lowStockTable tbody tr').length > 0) {
        $('#lowStockTable').DataTable({
            "order": [[3, "asc"]], // Sort by current stock ascending (lowest first)
            "pageLength": 25,
            "lengthMenu": [[10, 25, 50, 100, -1], [10, 25, 50, 100, "All"]],
            "columnDefs": [
                { "orderable": false, "targets": [6] }, // Disable sorting on actions column
                { "type": "num", "targets": [3, 4] } // Treat stock columns as numbers
            ],
            "responsive": true,
            "language": {
