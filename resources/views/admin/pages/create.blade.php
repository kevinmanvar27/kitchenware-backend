...
<div class="container-fluid h-100">
    <div class="row h-100">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
            @include('admin.layouts.header', ['pageTitle' => 'Create Page'])
                    ...
                    <div class="col-12">
                        <div class="card border-0 shadow-sm">
                            <div class="card-header bg-white border-0 py-3 d-flex justify-content-between align-items-center">
                                <div>
                                    <h4 class="card-title mb-0 fw-bold">Create Page</h4>
                                    <p class="mb-0 text-muted">Create a new page</p>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control rounded-pill" id="title" name="title" value="{{ old('title') }}" required>
                                                @error('title')
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="number" class="form-control rounded-pill" id="priority" name="priority" value="{{ old('priority', 0) }}" min="0">
