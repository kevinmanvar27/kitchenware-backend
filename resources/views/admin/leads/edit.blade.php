...
<div class="container-fluid h-100">
    <div class="row h-100">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
            @include('admin.layouts.header', ['pageTitle' => 'Edit Lead'])
                        ...
                        <div class="card border-0 shadow-sm">
                            <div class="card-header bg-white border-0 py-3 d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <p class="mb-0 text-muted">Update lead information</p>
                                </div>
                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ route('admin.leads.update', $lead) }}" method="POST" id="lead-form">
                                    @csrf
                                    @method('PUT')
                                    <div class="row">
                                        <div class="col-md-8">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control rounded-pill" id="name" name="name" value="{{ old('name', $lead->name) }}" required>
                                                @error('name')
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control rounded-3" id="note" name="note" rows="4">{{ old('note', $lead->note) }}</textarea>
                                                @error('note')
                                                    <div class="text-danger small mt-1">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="card border rounded-3 mt-3">
                                                ...
                                                <div class="card-body">
                                                    <p class="mb-1 small text-muted">Created: {{ $lead->created_at->format('M d, Y h:i A') }}</p>
                                                    <p class="mb-0 small text-muted">Updated: {{ $lead->updated_at->format('M d, Y h:i A') }}</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
